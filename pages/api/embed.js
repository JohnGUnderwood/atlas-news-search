...
router.get(async (req, res) => {
    if(!req.query.terms || !req.query.provider || req.query.model){
        console.log(`Request missing required parameters: terms, provider, model`)
        res.status(400).send(`Request missing required parameters: terms, provider, model`);
    }else{
